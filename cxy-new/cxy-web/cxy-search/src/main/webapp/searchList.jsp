...
<div class="shop_bd clearfix">
    ...
    <div class="shop_bd_list_right clearfix">
        ...
        <div class="shop_bd_list_content clearfix">
            <ul>
                <c:forEach items="${pageInfo.list}" var="product">
                    <li>
                        <dl>
                            <dt><a href=""><img src="${product.images}" /></a></dt>
        ...
        <div class="pagination">
            <ul><li><a href="/search/search?pageIndex=1&searchString=${searchString}"><span>首页</span></a></li>
                <c:if test="${pageInfo.pageNum >1}">

                <li><a href="/search/search?pageIndex=${pageInfo.pageNum-1}&searchString=${searchString}"><span>上一页</span></a></li>
                </c:if>
                <c:forEach items="${pageInfo.navigatepageNums}" var="num">
                    <c:choose>
                        <c:when test="${pageInfo.pageNum == num}">
                            <li><a href="/search/search?pageIndex=${num}&searchString=${searchString}"><span class="currentpage">${num}</span></a></li>
                        </c:when>
                        <c:otherwise>
                            <li><a href="/search/search?pageIndex=${num}&searchString=${searchString}"><span>${num}</span></a></li>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
                <c:if test="${pageInfo.pageNum < pageInfo.pages}">
                <li><a href="/search/search?pageIndex=${pageInfo.pageNum+1}&searchString=${searchString}"><span>下一页</span></a></li>
                </c:if>
                <li><a href="/search/search?pageIndex=${pageInfo.pages}&searchString=${searchString}"><span>末页</span></a></li>
            </ul>
        </div>
        <!-- 商品列表 End -->
